...
HD_PWD='D:/Projetos SD/project_trab1_sd/project_trab1_sd.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log trabalho1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source trabalho1.tcl
